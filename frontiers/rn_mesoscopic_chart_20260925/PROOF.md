...
- pin-site dotriacontic residuals `AD_grad_next = (1/8222838654177922817725562880000000)D³²f(z^31)`, `AD_height_next = (1/263130836933693530167218012160000000)D³²f(z^32)` with `z·AD_grad_next = 32 AD_height_next` (thirty-third-and-higher jets open);
...
- pin-site unmatched height-r power inventory for cubic through dotriacontic (`r^1`…`r^30`; none absorbed; thirty-third+ open);
...
- higher-order pin-site divided-difference jets beyond dotriacontic residuals;
