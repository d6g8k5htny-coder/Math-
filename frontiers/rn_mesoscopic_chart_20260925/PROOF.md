...
- pin-site tricosic residuals `X_grad_next = (1/1124000727777607680000)D²³f(z^22)`, `X_height_next = (1/25852016738884976640000)D²³f(z^23)` with `z·X_grad_next = 23 X_height_next` (twenty-fourth-and-higher jets open);
...
- pin-site unmatched height-r power inventory for cubic through tricosic (`r^1`…`r^21`; none absorbed; twenty-fourth+ open);
...
- higher-order pin-site divided-difference jets beyond tricosic residuals;
