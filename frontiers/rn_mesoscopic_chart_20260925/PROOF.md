...
- pin-site tritetracontic residuals `AO_grad_next = (1/1405006117752879898543142606244511569936384000000000)D⁴³f(z^42)`, `AO_height_next = (1/60415263063373835637355132068513997507264512000000000)D⁴³f(z^43)` with `z·AO_grad_next = 43 AO_height_next` (forty-fourth-and-higher jets open);
...
- pin-site unmatched height-r power inventory for cubic through tritetracontic (`r^1`…`r^41`; none absorbed; forty-fourth+ open);
...
- higher-order pin-site divided-difference jets beyond tritetracontic residuals;
