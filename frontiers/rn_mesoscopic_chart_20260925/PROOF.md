...
- pin-site heptacosic residuals `B_grad_next = (1/403291461126605635584000000)D²⁷f(z^26)`, `B_height_next = (1/10888869450418352160768000000)D²⁷f(z^27)` with `z·B_grad_next = 27 B_height_next` (twenty-eighth-and-higher jets open);
...
- pin-site unmatched height-r power inventory for cubic through heptacosic (`r^1`…`r^25`; none absorbed; twenty-eighth+ open);
...
- higher-order pin-site divided-difference jets beyond heptacosic residuals;
