...
- pin-site tetracosic residuals `Y_grad_next = (1/25852016738884976640000)D²⁴f(z^23)`, `Y_height_next = (1/620448401733239439360000)D²⁴f(z^24)` with `z·Y_grad_next = 24 Y_height_next` (twenty-fifth-and-higher jets open);
...
- pin-site unmatched height-r power inventory for cubic through tetracosic (`r^1`…`r^22`; none absorbed; twenty-fifth+ open);
...
- higher-order pin-site divided-difference jets beyond tetracosic residuals;
