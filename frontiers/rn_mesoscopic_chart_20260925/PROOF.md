...
- pin-site unmatched height-r power inventory for cubic through hexadecic (`r^1`…`r^14`; none absorbed; seventeenth+ open);
...
- higher-order pin-site divided-difference jets beyond hexadecic residuals;
