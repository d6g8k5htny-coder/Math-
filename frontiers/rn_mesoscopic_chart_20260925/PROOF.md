...
- pin-site octacosic residuals `C_grad_next = (1/10888869450418352160768000000)D²⁸f(z^27)`, `C_height_next = (1/304888344611713860501504000000)D²⁸f(z^28)` with `z·C_grad_next = 28 C_height_next`;
- pin-site nonacosic residuals `AA_grad_next = (1/304888344611713860501504000000)D²⁹f(z^28)`, `AA_height_next = (1/8841761993739701954543616000000)D²⁹f(z^29)` with `z·AA_grad_next = 29 AA_height_next`;
- pin-site triacontic residuals `AB_grad_next = (1/8841761993739701954543616000000)D³⁰f(z^29)`, `AB_height_next = (1/265252859812191058636308480000000)D³⁰f(z^30)` with `z·AB_grad_next = 30 AB_height_next`;
- pin-site hentriacontic residuals `AC_grad_next = (1/265252859812191058636308480000000)D³¹f(z^30)`, `AC_height_next = (1/8222838654177922817725562880000000)D³¹f(z^31)` with `z·AC_grad_next = 31 AC_height_next`;
- pin-site dotriacontic residuals `AD_grad_next = (1/8222838654177922817725562880000000)D³²f(z^31)`, `AD_height_next = (1/263130836933693530167218012160000000)D³²f(z^32)` with `z·AD_grad_next = 32 AD_height_next`;
- pin-site tritriacontic residuals `AE_grad_next = (1/263130836933693530167218012160000000)D³³f(z^32)`, `AE_height_next = (1/8683317618811886495518194401280000000)D³³f(z^33)` with `z·AE_grad_next = 33 AE_height_next`;
- pin-site tetratriacontic residuals `AF_grad_next = (1/8683317618811886495518194401280000000)D³⁴f(z^33)`, `AF_height_next = (1/295232799039604140847618609643520000000)D³⁴f(z^34)` with `z·AF_grad_next = 34 AF_height_next`;
- pin-site pentatriacontic residuals `AG_grad_next = (1/295232799039604140847618609643520000000)D³⁵f(z^34)`, `AG_height_next = (1/10333147966386144929666651337523200000000)D³⁵f(z^35)` with `z·AG_grad_next = 35 AG_height_next`;
- pin-site hexatriacontic residuals `AH_grad_next = (1/10333147966386144929666651337523200000000)D³⁶f(z^35)`, `AH_height_next = (1/371993326789901217467999448150835200000000)D³⁶f(z^36)` with `z·AH_grad_next = 36 AH_height_next`;
...
- pin-site hentetracontic residuals `AM_grad_next = (1/815915283247897734345611269596115894272000000000)D⁴¹f(z^40)`, `AM_height_next = (1/33452526613163807108170062053440751665152000000000)D⁴¹f(z^41)` with `z·AM_grad_next = 41 AM_height_next`;
- pin-site dotetracontic residuals `AN_grad_next = (1/33452526613163807108170062053440751665152000000000)D⁴²f(z^41)`, `AN_height_next = (1/1405006117752879898543142606244511569936384000000000)D⁴²f(z^42)` with `z·AN_grad_next = 42 AN_height_next`;
- pin-site tritetracontic residuals `AO_grad_next = (1/1405006117752879898543142606244511569936384000000000)D⁴³f(z^42)`, `AO_height_next = (1/60415263063373835637355132068513997507264512000000000)D⁴³f(z^43)` with `z·AO_grad_next = 43 AO_height_next`;
- pin-site tetratetracontic residuals `AP_grad_next = (1/60415263063373835637355132068513997507264512000000000)D⁴⁴f(z^43)`, `AP_height_next = (1/2658271574788448768043625811014615890319638528000000000)D⁴⁴f(z^44)` with `z·AP_grad_next = 44 AP_height_next`;
- pin-site pentatetracontic residuals `AQ_grad_next = (1/2658271574788448768043625811014615890319638528000000000)D⁴⁵f(z^44)`, `AQ_height_next = (1/119622220865480194561963161495657715064383733760000000000)D⁴⁵f(z^45)` with `z·AQ_grad_next = 45 AQ_height_next` (forty-sixth-and-higher jets open);
...
- pin-site unmatched height-r power inventory for cubic through pentatetracontic (`r^1`…`r^43`; none absorbed; forty-sixth+ open);
...
- higher-order pin-site divided-difference jets beyond pentatetracontic residuals;
