...
- pin-site dotetracontic residuals `AN_grad_next = (1/33452526613163807108170062053440751665152000000000)D⁴²f(z^41)`, `AN_height_next = (1/1405006117752879898543142606244511569936384000000000)D⁴²f(z^42)` with `z·AN_grad_next = 42 AN_height_next` (forty-third-and-higher jets open);
...
- pin-site unmatched height-r power inventory for cubic through dotetracontic (`r^1`…`r^40`; none absorbed; forty-third+ open);
...
- higher-order pin-site divided-difference jets beyond dotetracontic residuals;
