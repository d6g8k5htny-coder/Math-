...
- pin-site pentatriacontic residuals `AG_grad_next = (1/295232799039604140847618609643520000000)D³⁵f(z^34)`, `AG_height_next = (1/10333147966386144929666651337523200000000)D³⁵f(z^35)` with `z·AG_grad_next = 35 AG_height_next` (thirty-sixth-and-higher jets open);
...
- pin-site unmatched height-r power inventory for cubic through pentatriacontic (`r^1`…`r^33`; none absorbed; thirty-sixth+ open);
...
- higher-order pin-site divided-difference jets beyond pentatriacontic residuals;
