...
- pin-site nonacosic residuals `AA_grad_next = (1/304888344611713860501504000000)D²⁹f(z^28)`, `AA_height_next = (1/8841761993739701954543616000000)D²⁹f(z^29)` with `z·AA_grad_next = 29 AA_height_next` (thirtieth-and-higher jets open);
...
- pin-site unmatched height-r power inventory for cubic through nonacosic (`r^1`…`r^27`; none absorbed; thirtieth+ open);
...
- higher-order pin-site divided-difference jets beyond nonacosic residuals;
