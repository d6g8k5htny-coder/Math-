...
- pin-site hexatriacontic residuals `AH_grad_next = (1/10333147966386144929666651337523200000000)D³⁶f(z^35)`, `AH_height_next = (1/371993326789901217467999448150835200000000)D³⁶f(z^36)` with `z·AH_grad_next = 36 AH_height_next` (thirty-seventh-and-higher jets open);
...
- pin-site unmatched height-r power inventory for cubic through hexatriacontic (`r^1`…`r^34`; none absorbed; thirty-seventh+ open);
...
- higher-order pin-site divided-difference jets beyond hexatriacontic residuals;
