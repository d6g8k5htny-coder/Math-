...
Small-A (`A≤1/2`) is a separate diagnostic regime: pin-local frame, leading Morse + cubic through dodecic rows, max/saddle Hessian signature test, and obstruction ledger recorded; thirteenth-and-higher pin jets and density open.
