...
Small-A (`A≤1/2`) is a separate diagnostic regime: pin-local frame, leading Morse + cubic through decic rows, max/saddle Hessian signature test, and obstruction ledger recorded; eleventh-and-higher pin jets and density open.
